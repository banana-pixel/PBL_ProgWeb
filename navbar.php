      ...
      <li class="nav-item navbar-dropdown dropdown-user dropdown">
        <a
          ...
          <div class="avatar avatar-online">
            <span class="avatar-initial rounded-circle bg-primary d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; color: #fff; font-weight: bold;"><?php echo strtoupper(substr($nama_user, 0, 1)); ?></span>
          </div>
        </a>
